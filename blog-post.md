...
**[⬇ 기도여정 앱 다운로드 (v2.0.0 · 46MB)](https://github.com/joseph-84/prayerjourney/releases/download/v2.0.0/gidoyeojeong-v2.0.0.apk)**
...
A. 기기마다 메뉴 위치가 다를 수 있습니다. **설정 앱 → 보안 → 알 수 없는 앱 설치** 또는 **설정 → 애플리케이션 → 특별한 앱 권한 → 알 수 없는 앱 설치**를 찾아보세요.
